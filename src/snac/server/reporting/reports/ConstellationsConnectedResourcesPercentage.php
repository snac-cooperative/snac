 ...
 * @author Robbie Hott
 */
class ConstellationsConnectedResourcesPercentage extends helpers\Report {

    /**
     * The name of this report
     * @var string The name of this report
     */
    protected $name = "Constellations Connected To Resources Percentages";

    /**
     * @var string The description of this report
     */
    protected $description = "What percentage of our constellations are connected to only a few resources.";
    ...
    public function compute($psql) {
        ...
        $sql = "select resources, count(*) from name_index where resources < 4 group by resources order by resources asc;";
        ...
        foreach ($rawResults as $result) {
            $results[$result["resources"] . " Resources"] = ($result["count"] / (float) $total) * 100;
            $sum += $result["count"];
        }
